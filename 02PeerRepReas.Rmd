...
#Accross the United States the most deadly type of weather events are `r topHealthDamage[topHealthDamage$variable=="INJURIES",][1,]$EVTYPE`.  They have killed `r topHealthDamage[topHealthDamage$variable=="FATALITIES",][1,]$value` and injured `r topHealthDamage[topHealthDamage$variable=="INJURIES",][1,]$value`.  The most costly weather events are `r topPropDamage[topPropDamage$variable=="propDamageDollars",][1,]$EVTYPE` costing `r topPropDamage[topPropDamage$variable=="propDamageDollars",][1,]$value` in property damage and `r topPropDamage[topPropDamage$variable=="cropDamageDollars",][1,]$value` in crop damage.
```